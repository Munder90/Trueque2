...
<asp:Content ID="Modificacion" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="card-panel">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="mod_password" runat="server" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
            <asp:Label ID="mod_nopass" runat="server" ForeColor="White"></asp:Label>
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;<asp:Label ID="Label5" runat="server" Text="Confirmar Password:"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="mod_confpassword" runat="server" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
            <asp:Label ID="mod_nopass2" runat="server" ForeColor="White"></asp:Label>
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;
            ...
            <br />
            &nbsp;&nbsp;
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Ver Datos" BackColor="#999999" ForeColor="Black" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:Label ID="test" runat="server" Visible="False" ForeColor="White"></asp:Label>
            <br />
            <br />
            <br />
            <br />
